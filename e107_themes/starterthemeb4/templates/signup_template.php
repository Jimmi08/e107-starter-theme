...
/* extended version */
$extended = e107::pref('theme','signup_extended', false);

if($extended)  {

	$signup_layout_start = '
	<div class="col-md-5 ml-auto">
     {LAYOUT_ELEMENT: element=left_text}
   </div>
  <div class="col-md-5 mr-auto">';
	$signup_layout_end = '</div>';
	
	$SIGNUP_TEMPLATE['start'] = $signup_layout_start.$SIGNUP_BEGIN;
	$SIGNUP_BEGIN = $SIGNUP_TEMPLATE['start'];
	$SIGNUP_TEMPLATE['end'] = $SIGNUP_END.$signup_layout_end;
	$SIGNUP_END = $SIGNUP_TEMPLATE['end'];

	$SIGNUP_TEMPLATE['coppa']= $signup_layout_start.$COPPA_TEMPLATE.$signup_layout_end;
	$COPPA_TEMPLATE =  $SIGNUP_TEMPLATE['coppa'];
